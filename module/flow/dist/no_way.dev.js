...
/*#__PURE__*/
function (_Flow) {
  _inherits(NoWayFlow, _Flow);

  /*
  ** ### No Way Flow ###
  ** This flow is selected when context exists, cannot identify intent and cannot extract parameter.
  */
  function NoWayFlow(vp, bot_event, context, options) {
    var _this;

    _classCallCheck(this, NoWayFlow);
    ...
    */
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(NoWayFlow).call(this, vp, bot_event, context, options));
    _this.context._flow = "no_way";
    return _this;
  }

  _createClass(NoWayFlow, [{
    key: "run",
    value: function run() {
      ...
      return _get(_getPrototypeOf(NoWayFlow.prototype), "finish", this).call(this);
    } // End of run()
