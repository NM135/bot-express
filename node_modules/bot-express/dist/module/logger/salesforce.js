    ...
    async skill_status(channel_id, user_id, chat_id, skill, status, payload) {
        ...
        if (status === "launched") {
            ...
            if (payload.context && payload.context.confirming)
                skill_status.govtech__confirming__c = payload.context.confirming;
        }
            ...
            if (payload.intent && payload.intent.name)
                skill_status.govtech__intent__c = payload.intent.name;
            if (payload.context && payload.context.confirming)
                skill_status.govtech__confirming__c = payload.context.confirming;
        }
            ...
            if (payload.context && payload.context.launched_at)
                skill_status.govtech__ttc__c = new Date().getTime() - payload.context.launched_at;
        }
