...
/**
 * Function which is triggered at first.
 * @async
 * @method Skill#begin
 * @memberof Skill
 * @param {Bot} bot - Toolkit which can be used to access Messenger API, queuing message, collecting arbitrary parameter and son on.
 * @param {Object} event - Event object which triggers this flow.
 * @param {context} context - Context information.
 */
/**
 * Function which is triggered on abort
 * @async
 * @method Skill#abort
 * @memberof Skill
 * @param {Bot} bot - Toolkit which can be used to access Messenger API, queuing message, collecting arbitrary parameter and son on.
 ...
 */
/**
 * Function which is triggered on abend
 * @async
 * @method Skill#abend
 * @memberof Skill
 ...
 */
/**
 * Function which is triggered when all the required parameters are collected.
 * @async
 * @method Skill#finish
 * @memberof Skill
 * @param {Bot} bot - Toolkit which can be used to access Messenger API, queuing message, collecting arbitrary parameter and son on.
 ...
 * @prop {Skill#preaction} [preaction] - Function to run before sending message to collect the parameter.
 ...
 * @prop {Skill#reaction} [reaction] - Function to react to the message from user. Reaction runs right after parser returns.
 ...
 */
/**
 * Function to implicit apply value to the parameter. This is triggered before sending message.
 ...
 */
/**
 * The object of built-in parser configuration.
 ...
 */
/**
 * Function which is triggered when parser finished parsing. You can implement custom behavior on collecting parameter  including async action.
